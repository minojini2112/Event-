      ...
      <header className="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-white/80 backdrop-blur-xl border-b border-[#E2E8F0]/50 shadow-lg relative z-50">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
          <div>
            ...
            <p className="text-sm sm:text-base text-[#64748B] mt-1 sm:mt-2">Manage and monitor your events</p>
          </div>
          ...
          <div className="flex items-center relative" ref={profileRef}>
            ...
            {/* Profile Dropdown */}
            {isProfileOpen && (
              <div className="absolute top-12 sm:top-14 right-0 w-[20rem] sm:w-[22rem] bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-[#E2E8F0]/50 z-[99999] overflow-hidden">
                {/* Header Section */}
                <div className="bg-gradient-to-r from-[#3B82F6] to-[#06B6D4] p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/20 rounded-full flex items-center justify-center border border-white/30">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-6 sm:mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
          <div className="bg-white/90 backdrop-blur-sm border border-gray-200/60 rounded-xl p-4 sm:p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold text-gray-900">{userData.eventsCreated}</p>
              </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm border border-gray-200/60 rounded-xl p-4 sm:p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-gray-600">Total Participants</p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900">{userData.totalParticipants}</p>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          ...
          {!loading && !error && filteredEvents.map((event) => {
            ...
            return (
             ...
             >
              {/* Event Image */}
              <div className="relative h-40 sm:h-48 lg:h-52 bg-gradient-to-br from-blue-100 to-purple-100 overflow-hidden">
                {event.image_url ? (
                  <img 
                    src={event.image_url} 
              ...
              <div className="p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-[#1E40AF] text-lg sm:text-xl mb-3 line-clamp-2 group-hover:text-[#3B82F6] transition-colors duration-300">
                      {event.event_name}
                    </h3>
                    <div className="flex items-center text-[#64748B] mb-3">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#3B82F6]/10 rounded-xl flex items-center justify-center mr-2 sm:mr-3">
                    ...
                    <div className="flex items-center text-[#64748B] mb-3">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#10B981]/10 rounded-xl flex items-center justify-center mr-2 sm:mr-3">
                ...
                {/* Event Caption */}
                <p className="text-[#334155] text-xs sm:text-sm line-clamp-2 mb-4 leading-relaxed">
