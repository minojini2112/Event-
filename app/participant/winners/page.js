        ...
        {loading && (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-[#64748B] mt-6 text-lg font-medium">Loading your victories...</p>
            </div>
          </div>
        )}
            ...
            <aside className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white/90 backdrop-blur-xl border border-[#E2E8F0]/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-3xl font-black text-[#1E40AF] mb-2">{totalWins}</h2>
                  <p className="text-[#64748B] font-medium">Total Victories</p>
                </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="bg-gradient-to-r from-[#3B82F6]/10 to-[#06B6D4]/10 rounded-2xl p-4 border border-[#3B82F6]/20">
                      ...
                      <p className="text-[#64748B] text-sm">
                        Only <span className="font-bold text-[#1E40AF]">{remainingToNext}</span> more wins!
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="bg-white/90 backdrop-blur-xl border border-[#E2E8F0]/50 rounded-3xl p-6 shadow-xl">
                ...
                <div className="space-y-3">
                  {tiers.map((tier) => {
                    const achieved = totalWins >= tier.min;
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-gray-500">{tier.min}+ wins</div>
                            </div>
                          </div>
                          {achieved && (
            ...
            <section className="lg:col-span-3">
              ...
              {events.length === 0 ? (
                <div className="bg-white/90 backdrop-blur-xl border border-[#E2E8F0]/50 rounded-3xl p-16 text-center shadow-xl">
                  ...
                  <h3 className="text-2xl font-bold text-[#1E40AF] mb-2">No Victories Yet</h3>
                  <p className="text-[#64748B] mb-6">Start participating in events to win and build your success story!</p>
                  <button 
                    ...
                    >
                      ...
                      <div className="relative z-10 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className="w-16 h-16 bg-gradient-to-br from-[#10B981] to-[#059669] rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                            <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                            </svg>
                          </div>
                          <div>
                            ...
                            <div className="flex items-center gap-3">
                              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#ECFDF5] text-[#059669] border border-[#10B981]/20 font-medium text-sm">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                {formatYmd(event.start_date || event.date)}
                              </span>
                              <span className="text-[#64748B] text-sm">Victory #{index + 1}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <button 
                          ...
                          className="group/btn relative px-6 py-3 bg-gradient-to-r from-[#10B981] to-[#059669] text-white rounded-2xl font-semibold hover:from-[#059669] hover:to-[#047857] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 overflow-hidden"
                        >
                          <span className="relative z-10 flex items-center gap-2">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-r from-[#059669] to-[#10B981] opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                        </button>
                      </div>
                    </div>
                  ))}
