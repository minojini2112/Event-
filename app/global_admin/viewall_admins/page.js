  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6 sm:mb-8">
          <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-[#64748B]">Total Events</p>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-[#3B82F6]">Total Admins</p>
                <p className="text-xl sm:text-2xl font-semibold text-[#1E40AF] mt-1">{stats.totalAdmins}</p>
              </div>
              <div className="p-2 bg-[#EFF6FF] rounded-lg">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#3B82F6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-[#F59E0B]">Pending</p>
                <p className="text-xl sm:text-2xl font-semibold text-[#F59E0B] mt-1">{stats.pending}</p>
              </div>
        ...
        {/* Controls */}
        <div className="mb-4 sm:mb-6 bg-white border border-[#E2E8F0] rounded-xl p-4 sm:p-6 shadow-sm">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <select
                ...
                className="px-3 sm:px-4 py-2 sm:py-2.5 text-sm border border-[#E2E8F0] rounded-xl focus:ring-2 focus:ring-[#3B82F6] focus:border-[#3B82F6] bg-white text-[#334155] transition-all duration-200 hover:shadow-md min-w-[140px]"
              >
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full text-sm pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 border border-[#E2E8F0] rounded-xl focus:ring-2 focus:ring-[#3B82F6] focus:border-[#3B82F6] bg-white text-[#334155] placeholder-[#64748B] transition-all duration-200 hover:shadow-md"
              />
            </div>
          </div>
        </div>
          ...
          <div className="hidden lg:block overflow-x-auto">
            <table className="min-w-full table-fixed text-sm">
              ...
              <thead className="sticky top-0 z-10 bg-[#F8FAFC] border-b border-[#E2E8F0]">
                <tr>
                  <th className="text-left px-6 lg:px-8 py-4 lg:py-5 font-semibold text-[#334155] uppercase tracking-wide">
              ...
              <tbody className="divide-y divide-[#E2E8F0] bg-white">
                {loading && (
                  <tr>
                    <td colSpan={4} className="px-6 lg:px-8 py-8 lg:py-12 text-center">
                      <div className="flex flex-col items-center justify-center space-y-4">
                        <div className="animate-spin rounded-full h-10 w-10 lg:h-12 lg:w-12 border-4 border-[#E2E8F0] border-t-[#3B82F6]"></div>
                        <p className="text-[#64748B] font-medium text-sm lg:text-base">Loading admin data...</p>
                      </div>
                    </td>
                  </tr>
                )}
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 lg:px-8 py-8 lg:py-12 text-center">
                      <div className="flex flex-col items-center justify-center space-y-4">
                        ...
                        <p className="text-[#F59E0B] font-semibold text-base lg:text-lg">{error}</p>
                      </div>
                    </td>
                  </tr>
                )}
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 lg:px-8 py-8 lg:py-12 text-center">
                      <div className="flex flex-col items-center justify-center space-y-4">
                        ...
                        <div>
                          <p className="text-[#334155] font-semibold text-base lg:text-lg">No records found</p>
                          <p className="text-[#64748B] mt-1 text-sm lg:text-base">Try adjusting your search or filter criteria</p>
                        </div>
                      </div>
                    </td>
                  </tr>
                ...
                {!loading && !error && groupedByAdmin.map(([adminName, items]) => (
                  items.map((r, idx) => (
                    <tr key={r.id} className="group hover:bg-[#F8FAFC] transition-all duration-200">
                      {idx === 0 && (
                        <td rowSpan={items.length} className="px-6 lg:px-8 py-4 lg:py-6 align-top bg-[#F8FAFC] border-r border-[#E2E8F0]">
                          <div className="flex items-center space-x-3">
                            <div className="flex-shrink-0">
                              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-[#3B82F6] rounded-xl flex items-center justify-center text-white font-bold text-sm lg:text-lg shadow-sm">
                                {adminName.charAt(0).toUpperCase()}
                              </div>
                            </div>
                            <div>
                              <p className="font-semibold text-[#334155] text-sm lg:text-base group-hover:text-[#3B82F6] transition-colors">{adminName}</p>
                              <p className="text-xs text-[#64748B] mt-1">{items.length} event{items.length !== 1 ? 's' : ''}</p>
                            </div>
                          </div>
                        </td>
                      )}
                      <td className="px-6 lg:px-8 py-4 lg:py-6 text-[#334155] font-medium">
                        <div className="flex items-center space-x-2">
                          <div className="w-2 h-2 bg-[#06B6D4] rounded-full flex-shrink-0"></div>
                          <span className="truncate max-w-[15rem] lg:max-w-[20rem]" title={r.event_name || ''}>
                            {r.event_name || '-'}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 lg:px-8 py-4 lg:py-6">
                        <span className={`inline-flex items-center gap-2 px-2 lg:px-3 py-1 lg:py-1.5 rounded-full border text-xs font-medium transition-all duration-200 ${statusBadge(r.status)}`}>
                      ...
                      <td className="px-6 lg:px-8 py-4 lg:py-6 text-[#64748B] font-medium">
                        <div className="flex items-center space-x-2">
                          <svg className="w-3 h-3 lg:w-4 lg:h-4 text-[#64748B] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 6v6a2 2 0 002 2h4a2 2 0 002-2v-6" />
                          </svg>
          ...
          <div className="lg:hidden">
            {loading && (
              <div className="p-8 text-center">
                <div className="flex flex-col items-center justify-center space-y-4">
                  <div className="animate-spin rounded-full h-10 w-10 border-4 border-[#E2E8F0] border-t-[#3B82F6]"></div>
                  <p className="text-[#64748B] font-medium text-sm">Loading admin data...</p>
                </div>
              </div>
            )}
            ...
            {error && !loading && (
              <div className="p-8 text-center">
                <div className="flex flex-col items-center justify-center space-y-4">
                  ...
                  <p className="text-[#F59E0B] font-semibold text-base">{error}</p>
                </div>
              </div>
            )}
            ...
            {!loading && !error && filtered.length === 0 && (
              <div className="p-8 text-center">
                <div className="flex flex-col items-center justify-center space-y-4">
                  ...
                  <div>
                    <p className="text-[#334155] font-semibold text-base">No records found</p>
                    <p className="text-[#64748B] mt-1 text-sm">Try adjusting your search or filter criteria</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {!loading && !error && groupedByAdmin.map(([adminName, items]) => (
              <div key={adminName} className="border-b border-[#E2E8F0] last:border-b-0">
                <div className="p-4 bg-[#F8FAFC] border-b border-[#E2E8F0]">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-semibold text-[#334155] text-base">{adminName}</p>
                      <p className="text-xs text-[#64748B] mt-1">{items.length} event{items.length !== 1 ? 's' : ''}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-0">
                  {items.map((r) => (
                    <div key={r.id} className="p-4 border-b border-[#E2E8F0] last:border-b-0">
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          <div className="w-2 h-2 bg-[#06B6D4] rounded-full flex-shrink-0"></div>
                          <p className="text-sm text-[#334155] font-medium">{r.event_name || '-'}</p>
                        </div>
