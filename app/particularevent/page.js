              ...
              <div className="mt-4 flex flex-wrap items-center gap-3">
                ...
                {showParticipantCTAs && eventStatus?.showRegistration && (
                  <button 
                    ...
                    className={`px-5 py-2.5 rounded-lg text-sm font-semibold shadow-md transition-all duration-200 ${
                      isRegistered 
                        ? 'bg-green-100/30 border border-green-400/40 text-green-200 cursor-not-allowed' 
